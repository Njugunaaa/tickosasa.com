...
const AdminShows = ({killEvent,shows}) => {
  return (
    <div>
      <h1 className="text-2xl font-bold p-4">Admin Editing Pane</h1>
        ...
        {shows.map((show) => (
          ...
          >
            ...
            <div className="p-4 flex flex-col space-y-1">
              ...
              <button onClick={()=>killEvent(show)}className="bg-red-600 40px">🗑️</button>
            </div>
          </div>
        ))}
      </div>
